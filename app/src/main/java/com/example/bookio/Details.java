...
public class Details extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        datefrom = findViewById(R.id.textView14);
        dateto = findViewById(R.id.textView16);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()){
            ...
            case R.id.Close:
                //this.finish();
                //System.exit(0);
                Intent intent1 = new Intent(Details.this, Close.class);
//Clear all activities and start new task
            ...
            case R.id.Contact:
                ...
                intent2.setData(Uri.parse("tel: "+"010-2243245"));
